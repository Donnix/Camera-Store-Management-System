...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Register || Dox Camera Shop</title>
      ...
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Your Last Name" name="lname" required>
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder=" Your Address" name="address"required>
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Your City" name="city" required>
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="number" id="right-label" placeholder="pin code" name="pin" required>
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="Your E-mail" name="email" required>
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
